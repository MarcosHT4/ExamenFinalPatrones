...
public class Cochabamba implements IDeparatamento {
    ...
    public Cochabamba(int nroProvincias, int nroHabitantes, String clima, double dineroPorTurismo) {
        nombre = "Cochabamba";
    ...
    @Override
    public void visitadoPorTurista(ITurista turista) {
